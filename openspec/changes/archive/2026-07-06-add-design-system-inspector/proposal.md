...
- Archive the `docs/design/` bundle as the design source of record and the zip-html adapter's first golden fixture (per the bundle's own dogfood note).
