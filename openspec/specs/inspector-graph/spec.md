# Capability: Inspector Graph

## Purpose

Interactive graph visualization of component-token wiring using React Flow, with component and token lenses, edge rewiring, and live value editing.
