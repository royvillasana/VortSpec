# component-scaffold Specification

## Purpose
A deterministic file set per component, derived from the project's framework, language and styling. Removes structural variance from component creation so a missing file is a scaffold failure with a name rather than an apparent generation-quality problem.
