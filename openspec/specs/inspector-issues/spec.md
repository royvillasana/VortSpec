# Capability: Inspector Issues

## Purpose

Project-wide issue tracking panel with severity/kind/component filtering, deep links to affected entities, and one-click suggested actions.
