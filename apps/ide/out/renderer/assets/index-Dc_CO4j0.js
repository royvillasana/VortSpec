...
${text}` : text;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "flex h-full w-[360px] shrink-0 flex-col border-l border-vs-border-default bg-vs-bg-surface", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: scrollRef, className: "min-h-0 flex-1 overflow-y-auto px-4 py-4", children: !started ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col items-center justify-center gap-2 text-center", children: [
      ...
      firstPrompt && /* @__PURE__ */ jsxRuntimeExports.jsx(Bubble$1, { role: "user", text: firstPrompt }),
      run.model.messages.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(Bubble$1, { role: m.role, text: m.text }, m.id)),
      run.model.streamingText && /* @__PURE__ */ jsxRuntimeExports.jsx(Bubble$1, { role: "assistant", text: run.model.streamingText }),
...
function projectRailItems(active, nav, badges) {
  const defs = [
    ...
    ...nav.onRunApp ? [{ key: "runapp", label: "Run app", onClick: nav.onRunApp }] : [],
    { key: "tokens", label: "Tokens", onClick: nav.onTokens },
    { key: "manifest", label: "Manifest", onClick: nav.onManifest },
    ...nav.onSource ? [{ key: "source", label: "Source Control", onClick: nav.onSource }] : [],
    ...nav.onTasks ? [{ key: "tasks", label: "Tasks (Jira)", onClick: nav.onTasks }] : [],
...
function SourceControl({
  ...
  const [importBranch, setImportBranch] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-[calc(100vh-3rem)] w-full overflow-hidden bg-vs-bg-primary text-[13px] text-vs-text-primary", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex min-w-0 flex-1 flex-col overflow-y-auto bg-vs-bg-primary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex flex-none items-center gap-3 border-b border-vs-border-default px-8 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold tracking-[-0.01em]", children: "Source Control" }),
        status?.isRepo && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded border border-vs-border-default px-1.5 py-px font-mono text-[11px] text-vs-text-secondary", children: status.branch ?? "detached" }),
          (status.ahead > 0 || status.behind > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-vs-text-muted", children: [
            "↑",
            status.ahead,
            " ↓",
            status.behind
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void reload(), className: "text-xs text-vs-text-secondary hover:text-vs-text-primary", children: "↻ Refresh" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto flex w-full max-w-[760px] flex-col gap-5 px-8 py-6", children: status === null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-vs-text-secondary", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}),
        " Reading git…"
      ] }) : notRepo ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex flex-col items-start gap-4 p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-vs-text-secondary", children: "This folder isn't a git repository yet." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "default", disabled: busy !== null, onClick: () => void act("init", () => api.gitInit(project.path)), children: "Initialize repository" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full flex-col gap-2 border-t border-vs-border-default pt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-vs-text-primary", children: "Import a GitHub repo as the design source" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-vs-text-muted", children: "Bring a repository into this project, then run the Design system stage to scan its tokens and components and build them locally." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: () => void act(
                  "import",
                  () => api.gitImport({ projectPath: project.path, url: importUrl.trim(), branch: importBranch.trim() || void 0 })
                ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[13px] font-semibold uppercase tracking-wide text-vs-text-muted", children: "Branch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex flex-wrap items-center gap-2 p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                value: status.branch ?? "",
                ...
                children: [
                  localBranches.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: b.name, children: b.name }, b.name)),
                  status.branch && !localBranches.some((b) => b.name === status.branch) && /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: status.branch, children: status.branch })
                ]
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: () => void act("createBranch", () => api.gitCreateBranch(project.path, newBranch.trim())).then(() => setNewBranch("")),
                children: "Create & switch"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-vs-text-muted", children: "VortSpec only creates and switches branches — it never deletes a branch or rewrites history." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[13px] font-semibold uppercase tracking-wide text-vs-text-muted", children: "Changes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "flex flex-col p-0", children: status.clean ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "p-4 text-sm text-vs-text-muted", children: "Working tree clean." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ChangeGroup,
              {
                title: "Staged",
                rows: status.staged.map((c) => ({ path: c.path, tag: c.status })),
                action: "Unstage",
                disabled: busy !== null,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                title: "Changes",
                rows: [...status.unstaged.map((c) => ({ path: c.path, tag: c.status })), ...status.untracked.map((p) => ({ path: p, tag: "untracked" }))],
                action: "Stage",
                disabled: busy !== null,
                onAction: (p) => void act("stage", () => api.gitStage(project.path, [p]))
              }
            ),
            status.conflicts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-vs-border-default px-4 py-2 text-xs text-vs-error", children: [
              "Conflicts: ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "default", disabled: busy !== null, onClick: () => void act("fetch", () => api.gitFetch(project.path)), children: "Fetch" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "default", disabled: busy !== null, onClick: () => void act("pull", () => api.gitPull(project.path)), children: "Pull" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "default", disabled: busy !== null, onClick: () => void act("push", () => api.gitPush(project.path)), children: "Push" })
          ] }),
          busy && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 text-xs text-vs-text-secondary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}),
            " ",
            busy,
            "…"
    ...
    toast && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-5 left-1/2 -translate-x-1/2 rounded-lg border border-vs-border-strong bg-vs-bg-elevated px-4 py-2 text-xs text-vs-text-primary shadow-2xl", children: toast })
  ] });
}
function GitHubConnect({
  ...
  const [createProvider, setCreateProvider] = reactExports.useState("github");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex flex-col gap-2.5 p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-semibold uppercase tracking-wide text-vs-text-muted", children: providerLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1" }),
      auth === null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-xs text-vs-text-muted", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}),
        " checking…"
      ] }) : auth.authenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-xs text-vs-success", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block h-1.5 w-1.5 rounded-full bg-vs-success" }),
        "Connected",
        auth.accounts.length <= 1 && ` as ${auth.activeAccount}`
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void onChanged(), className: "text-xs text-vs-accent hover:underline", children: "Connect / re-check" })
    ] }),
    origin && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[11px] text-vs-text-secondary", children: origin }),
    auth && !auth.authenticated && auth.hint && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "rounded-md border border-vs-warning-border bg-vs-warning-muted px-3 py-2 text-[11px] text-vs-warning", children: auth.hint }),
    auth && auth.authenticated && auth.accounts.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-xs text-vs-text-secondary", children: [
      "Account",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "select",
        {
          ...
          children: auth.accounts.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: a, children: a }, a))
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-vs-text-muted", children: [
        auth.accounts.length,
        " accounts — pick which to use"
      ] })
    ] }),
    auth && auth.authenticated && !origin && (creating ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "github", children: "GitHub" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "gitlab", children: "GitLab" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setCreating(false), className: "text-xs text-vs-text-muted hover:text-vs-text-primary", children: "Cancel" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "default", disabled: busy, onClick: () => setCreating(true), children: "Create a repo (GitHub / GitLab) & push this folder" }) })),
    auth && auth.authenticated && origin && branch && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        variant: "default",
        disabled: busy,
    ...
    auth && auth.authenticated && origin && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5 border-t border-vs-border-default pt-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          variant: "primary",
          ...
          children: "Publish design system → new branch + PR"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-vs-text-muted", children: manifestReady ? "Creates the vortspec/design-system branch, commits the generated tokens/components/DESIGN.md, pushes, and opens a PR. Never pushes to main." : "Available once DESIGN.md is generated (the design-system gate). Generate the manifest first." })
    ] })
  ] });
}
function ChangeGroup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-vs-border-default last:border-b-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-vs-bg-primary px-4 py-1.5 text-[10px] font-semibold uppercase tracking-wide text-vs-text-muted", children: [
      title,
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-vs-border-strong", children: rows.length })
    ] }),
    rows.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-1.5 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-16 shrink-0 text-vs-text-muted", children: r.tag }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 truncate font-mono text-vs-text-primary", children: r.path }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled, onClick: () => onAction(r.path), className: "text-vs-accent hover:underline disabled:opacity-40", children: action })
    ] }, r.path))
  ] });
}
function RunPanel({
...
function Tasks({
  ...
  const [proj, setProj] = reactExports.useState("");
  const [summary, setSummary] = reactExports.useState("");
  const [description, setDescription] = reactExports.useState("");
  const [type, setType] = reactExports.useState("Story");
  const [busy, setBusy] = reactExports.useState(null);
  const [toast, setToast] = reactExports.useState("");
  const [confirmInstall, setConfirmInstall] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-[calc(100vh-3rem)] w-full overflow-hidden bg-vs-bg-primary text-[13px] text-vs-text-primary", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex min-w-0 flex-1 flex-col overflow-y-auto bg-vs-bg-primary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex flex-none items-center gap-3 border-b border-vs-border-default px-8 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold tracking-[-0.01em]", children: "Tasks" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded border border-vs-border-default px-1.5 py-px text-[10px] uppercase tracking-wide text-vs-text-muted", children: "Jira" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void loadAuth(), className: "text-xs text-vs-text-secondary hover:text-vs-text-primary", children: "↻ Refresh" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex w-full max-w-[720px] flex-col gap-5 px-8 py-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex flex-col gap-2.5 p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-semibold uppercase tracking-wide text-vs-text-muted", children: "Jira" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1" }),
            auth === null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-xs text-vs-text-muted", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}),
              " checking…"
            ] }) : auth.configured ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-xs text-vs-success", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block h-1.5 w-1.5 rounded-full bg-vs-success" }),
              " Connected as ",
              auth.account
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => void loadAuth(), className: "text-xs text-vs-accent hover:underline", children: "Connect / re-check" })
          ] }),
          auth && !auth.configured && auth.hint && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "rounded-md border border-vs-warning-border bg-vs-warning-muted px-3 py-2 text-[11px] text-vs-warning", children: auth.hint }),
          auth && !auth.cliInstalled && auth.installCommand && (confirmInstall ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 rounded-md border border-vs-border-default bg-vs-bg-primary p-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-vs-text-secondary", children: "VortSpec will run, with your permission:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "rounded bg-vs-bg-code px-2 py-1 font-mono text-[11px] text-vs-text-primary", children: auth.installCommand }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "primary", disabled: busy !== null, onClick: () => void run("install", () => api.taskInstall()).then(() => setConfirmInstall(false)), children: busy ? "Installing…" : "Install the Jira CLI" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setConfirmInstall(false), className: "text-xs text-vs-text-muted hover:text-vs-text-primary", children: "Cancel" })
            ] })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "default", disabled: busy !== null, onClick: () => setConfirmInstall(true), children: "Install the Jira CLI (with permission)" }) }))
        ] }),
        auth?.configured && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[13px] font-semibold uppercase tracking-wide text-vs-text-muted", children: "Create a story" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex flex-col gap-2.5 p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: proj, onChange: (e) => setProj(e.target.value), className: "rounded-md border border-vs-border-default bg-vs-bg-primary px-2 py-1.5 text-xs", children: [
                projects.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "No projects" }),
                projects.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: p.key, children: [
                  p.key,
                  " — ",
                  p.name
                ] }, p.key))
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: type, onChange: (e) => setType(e.target.value), className: "rounded-md border border-vs-border-default bg-vs-bg-primary px-2 py-1.5 text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Story", children: "Story" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Task", children: "Task" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Bug", children: "Bug" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: summary, onChange: (e) => setSummary(e.target.value), placeholder: "Summary", className: "min-w-[260px] flex-1 rounded-md border border-vs-border-default bg-vs-bg-primary px-2.5 py-1.5 text-xs placeholder:text-vs-text-muted" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: 3, value: description, onChange: (e) => setDescription(e.target.value), placeholder: "Description / acceptance criteria (optional)", className: "w-full resize-y rounded-md border border-vs-border-default bg-vs-bg-primary px-3 py-2 text-xs placeholder:text-vs-text-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-vs-accent-subtle" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "primary",
                disabled: busy !== null || !proj || !summary.trim(),
                onClick: () => void run("create story", () => api.taskCreateIssue({ project: proj, type, summary: summary.trim(), description: description.trim() || void 0 })).then(() => {
                  setSummary("");
                  setDescription("");
                }),
                children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-vs-text-muted", children: `Tip: from the Flow, a component's spec can become a story — "the spec is the story".` })
          ] })
        ] }),
        auth?.configured && Object.keys(links).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[13px] font-semibold uppercase tracking-wide text-vs-text-muted", children: "Linked stories" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "flex flex-col p-0", children: Object.entries(links).map(([ref, key]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border-b border-vs-border-default px-4 py-2 text-xs last:border-b-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 truncate text-vs-text-primary", children: ref }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-vs-text-secondary", children: key })
          ] }, ref)) })
        ] })
      ] })
    ] }),
    toast && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-5 left-1/2 -translate-x-1/2 max-w-[80vw] truncate rounded-lg border border-vs-border-strong bg-vs-bg-elevated px-4 py-2 text-xs text-vs-text-primary shadow-2xl", children: toast })
  ] });
}
...
const ITEMS = [
  {
    key: "explorer",
    label: "Explorer",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 4.5A1.5 1.5 0 0 1 4.5 3h4l2 2.5h5A1.5 1.5 0 0 1 17 7v8.5A1.5 1.5 0 0 1 15.5 17h-11A1.5 1.5 0 0 1 3 15.5v-11Z" })
  },
  {
    key: "source",
    label: "Source Control",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M6 3a2.5 2.5 0 0 0-1 4.79V12.2A2.5 2.5 0 1 0 7 12.2V9.9c.6.4 1.3.6 2 .6h1.2A2.5 2.5 0 1 0 12.5 8H11c-1.1 0-2-.9-2-2V4.79A2.5 2.5 0 0 0 6 3Z" })
  },
  {
    key: "tokens",
    label: "Design tokens",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M10 2 3 6v8l7 4 7-4V6l-7-4Zm0 2.3L14.7 7 10 9.7 5.3 7 10 4.3Z" })
  },
  {
    key: "tasks",
    label: "Tasks",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 4.5A1.5 1.5 0 0 1 5.5 3h9A1.5 1.5 0 0 1 16 4.5v11A1.5 1.5 0 0 1 14.5 17h-9A1.5 1.5 0 0 1 4 15.5v-11ZM7 7h6M7 10h6M7 13h4" })
  },
  {
    key: "manifest",
    label: "Design manifest",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M6 3h5l3 3v11a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Zm5 0v3h3" })
  }
];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      ...
      children: [
        ITEMS.map((item) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `relative flex h-10 w-10 items-center justify-center rounded-md transition-colors ${on ? "text-vs-text-primary" : "text-vs-text-muted hover:text-vs-text-secondary"}`,
              children: [
                on && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-0 top-1.5 h-7 w-0.5 rounded-r bg-vs-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
                    width: "20",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            className: `flex h-10 w-10 items-center justify-center rounded-md transition-colors ${chatOpen ? "text-vs-accent" : "text-vs-text-muted hover:text-vs-text-secondary"}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 4h12a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H8l-3.5 3V13H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1Z" }) })
          }
        )
      ]
    }
...
function WorkspacePicker({ onOpen }) {
  const [recent, setRecent] = reactExports.useState(null);
  const [busy, setBusy] = reactExports.useState(false);
  reactExports.useEffect(() => {
    void api.listProjects().then(setRecent).catch(() => setRecent([]));
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full w-full items-center justify-center bg-vs-bg-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-semibold text-vs-text-primary", children: "VortSpec IDE" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-vs-text-secondary", children: "Open a project to create components, document them, and vibe-engineer against a live preview." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => void openFolder(), disabled: busy, children: [
      busy ? /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}) : null,
      "Open a folder…"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2 text-[11px] font-semibold uppercase tracking-wide text-vs-text-muted", children: "Recent" }),
      recent === null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-vs-text-muted", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {}),
        " Loading…"
      ] }) : recent.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-vs-text-muted", children: "No recent projects yet." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-1", children: recent.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          onClick: () => onOpen(p),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-vs-text-primary", children: p.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate font-mono text-[11px] text-vs-text-muted", children: p.path })
          ]
        }
      ) }, p.path)) })
    ] })
...
function CodeWorkspace({ project }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "flex w-60 shrink-0 flex-col border-r border-vs-border-default bg-vs-bg-surface", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold uppercase tracking-wide text-vs-text-muted", children: "Explorer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "15", height: "15", viewBox: "0 0 20 20", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 6.5A1.5 1.5 0 0 1 4.5 5h3l1.5 2h6A1.5 1.5 0 0 1 16.5 8.5v5A1.5 1.5 0 0 1 15 15H4.5A1.5 1.5 0 0 1 3 13.5v-7Z" }) })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pb-2 text-sm text-vs-text-primary", children: project.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-3 rounded-md border border-dashed border-vs-border-default p-3 text-xs text-vs-text-muted", children: "The file tree and Monaco editor arrive in I2. For now, open files from your terminal or reveal the folder above." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1 flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "flex flex-1 items-center justify-center border-b border-vs-border-default bg-vs-bg-code", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-sm text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-vs-text-secondary", children: "Editor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-vs-text-muted", children: "Monaco (VS Code's editor engine) mounts here in I2 — open, edit, and diff files scoped to the workspace." })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "flex h-2/5 items-center justify-center bg-vs-bg-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-sm text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-vs-text-secondary", children: "Live preview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-vs-text-muted", children: "The running app / Storybook embeds here in I4 — screens on one side, code on the other." })
      ] }) })
    ] })
  ] });
}
function App() {
  ...
  const [activity, setActivity] = reactExports.useState("explorer");
  const [chatOpen, setChatOpen] = reactExports.useState(true);
  const [userName, setUserName] = reactExports.useState(void 0);
  reactExports.useEffect(() => {
    void api.getProfile().then((p) => setUserName(p.name || void 0)).catch(() => void 0);
  }, []);
  if (!workspace) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-screen w-screen overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      WorkspacePicker,
      {
        onOpen: (project) => {
  ...
  const goExplorer = () => setActivity("explorer");
  const goTokens = () => setActivity("tokens");
  const goManifest = () => setActivity("manifest");
  const goSource = () => setActivity("source");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen w-screen flex-col overflow-hidden bg-vs-bg-primary text-vs-text-primary", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-0 flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex min-w-0 flex-1 overflow-hidden", children: [
        activity === "explorer" && /* @__PURE__ */ jsxRuntimeExports.jsx(CodeWorkspace, { project: workspace }),
        activity === "source" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-1 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          SourceControl,
          {
            project: workspace,
            onBack: goExplorer,
        ...
        activity === "tokens" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-1 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Inspector,
          {
            project: workspace,
            onBack: goExplorer,
        ...
        activity === "tasks" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-1 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Tasks,
          {
            project: workspace,
            onBack: goExplorer,
        ...
        activity === "manifest" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-1 overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          DesignManifest,
          {
            project: workspace,
            onBack: goExplorer,
      ...
      chatOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-[380px] shrink-0 flex-col border-l border-vs-border-default", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        AssistantDock,
        {
          project: workspace,
          allowModify: true,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "flex h-6 shrink-0 items-center gap-3 border-t border-vs-border-default bg-vs-bg-surface px-3 text-[11px] text-vs-text-muted", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-vs-text-muted/60", children: "·" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize", children: activity })
    ] })
  ] });
}
