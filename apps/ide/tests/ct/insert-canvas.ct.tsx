...
test.fixme("insert mode draws a vertical line for a row flow", async ({ mount }) => {
...
// QUARANTINED [REGISTRY] — see QUARANTINE.md
test.fixme("insert mode draws a horizontal line for a column flow", async ({ mount }) => {
...
// QUARANTINED [REGISTRY] — see QUARANTINE.md
test.fixme("a placed placeholder shows the resizable box and hides the line", async ({ mount }) => {
...
// QUARANTINED [REGISTRY] — see QUARANTINE.md
test.fixme("a lost placeholder surfaces a human sentence with a dismiss", async ({ mount }) => {
...
// QUARANTINED [REGISTRY] — see QUARANTINE.md
test.fixme("insert affordances draw only in insert mode", async ({ mount }) => {
