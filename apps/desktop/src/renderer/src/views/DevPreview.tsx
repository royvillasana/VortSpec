                ...
                {dev.state === "starting" ? (
                  ...
                  <>
                    ...
                    <p className="text-xs text-zinc-500">
                      {dev.message} A gallery/Storybook harness can be generated by Claude Code
                      (coming next); until then, paste a running dev-server URL below.
                    </p>
                  ...
                  <>
                    ...
                    <p className="text-xs text-zinc-500">
                      Start the project&rsquo;s dev server to render components live, or paste a URL
