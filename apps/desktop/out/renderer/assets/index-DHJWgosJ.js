    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex min-w-0 flex-1 flex-col bg-vs-bg-primary", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-0 flex-1 overflow-y-auto transition-colors", style: { background: BG[bg] }, children: embedUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-zinc-500", children: [
          dev.message,
          " A gallery/Storybook harness can be generated by Claude Code (coming next); until then, paste a running dev-server URL below."
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-zinc-500", children: "Start the project’s dev server to render components live, or paste a URL you’re already running." }),
