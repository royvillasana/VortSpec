...
export function buildLightPagePrompt(name: string, description: string): string {
  return [
    ...
    "5. INTERACTIVITY (Astro-style islands): ONLY where a screen genuinely needs client behavior (tabs,",
    ...
    `6. WRITE the page to \`${lightPagePath(name)}\` (create the dir). This file is your ONLY output.`,
    "",
