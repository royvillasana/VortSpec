...
const api: VortSpecApi = {
  ...
  enterpriseStorybookUrl: (projectPath: string) => invoke("enterprise:storybookUrl", projectPath),
  enterpriseSnapshotPrompt: (projectPath: string) => invoke("enterprise:snapshotPrompt", projectPath),
  enterpriseGeneratePrompt: (projectPath: string) => invoke("enterprise:generatePrompt", projectPath),
  ...
  ) => invoke("canvas:writeEdit", { projectPath, file, edit, expect }),
