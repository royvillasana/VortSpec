  ...
  return (
    <Streamdown
      className={cn(
        ...
        "[&_ul]:my-1.5 [&_ul]:list-disc [&_ul]:ps-4 [&_ol]:my-1.5 [&_ol]:list-decimal [&_ol]:ps-4 [&_li]:my-0.5",
        ...
        "[&_blockquote]:border-l-2 [&_blockquote]:border-vs-border-strong [&_blockquote]:ps-2 [&_blockquote]:text-vs-text-muted",
